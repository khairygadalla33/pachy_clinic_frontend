        ...
        {filteredServices.length === 0 ? (
          ...
          filteredServices.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className={`bg-white rounded-2xl p-4 sm:p-5 border transition-all duration-200 shadow-2xs hover:shadow-md ${
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-baseline gap-1.5 mt-3">
                      {hasMultiplePricings ? (
                        <>
                          <span className="text-xs font-medium text-slate-500">تبدأ من</span>
                          <span className="text-lg sm:text-xl font-black text-rose-600">{minPrice}</span>
                          <span className="text-xs font-bold text-slate-700">ج.م</span>
                          <span className="text-xs text-purple-600 font-semibold mr-1.5">
